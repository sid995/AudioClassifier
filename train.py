...
class ESC50Dataset(Dataset):
    ...
    # Override the getitem method to return the audio waveform and label
    # for a given index
    def __getitem__(self, idx):
        ...
        # waveform -> [channel, samples] -> [2, 44000] converted to [1, 44000]
...
def train():
    ...
    schedular = OneCycleLR(  # Overwrites the learning rate
        optimizer=optimizer,
        max_lr=0.002,
        epochs=num_epochs,
